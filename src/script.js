...
list.innerHTML = dataJson.map(action => {
    return `<li class="details__item details__item--${action["title"]}">
                            <div class="details__item-info">
                                <p class="details__item-action">${action["title"]}</p>
                                <img src="./../images/icon-ellipsis.svg" alt="" class="details__item-more">
                                <h2 class="details__item-hours">${action["timeframes"]["daily"]["current"]}hrs</h2>
                                <span class="details__item-last">Last week - ${action["timeframes"]["daily"]["previous"]}hrs</span>
                            </div>
